...
- Browser E2E now also covers first-load failure and manual retry recovery for the dashboard summary and dispatch list pages, tightening the `loading/error/retry` regression line for core operator-facing screens.
